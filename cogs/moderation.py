...
class Moderation(commands.Cog):
    ...
    async def kick(self, ctx, member: discord.Member = None): # type: ignore
        if member == None:
            ...
            ).set_author(icon_url="https://cdn.discordapp.com/avatars/1092056353431887935/a6e3943b277ae77dc64136dceba314dd.webp?size=512&width=0&height=0", name="ghoul").add_field(name="usage", value="kick [user]")
